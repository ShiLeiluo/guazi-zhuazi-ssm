...
<section class="wrapper">
    ...
    <section id="undoneorder">
        ...
        <section class="main-content">
            <h3>预售车辆
                <br>
                <small>可查阅预售车辆信息</small>
            </h3>
            <!-- START panel-->
            <div class="panel panel-default">
                <div class="panel-heading">预售车辆信息
                ...
                <div class="table-responsive">
                    <table id="table-id" class="table table-bordered table-hover">
                        ...
                        <c:forEach items="${unchecksell}" var="unchecksell">
                            <tr>
                                <td>${unchecksell.id}</td>
                                <td><img src="${unchecksell.pic}" style="width: 47px;height: 32px;"></td>
                                <td><a href="/detail?id=${unchecksell.id}">${unchecksell.name}</a></td>
                                <td>${unchecksell.nowprice}</td>
                                <td>${unchecksell.phone}</td>
                                <td>${unchecksell.cityname}</td>
                                <td>${unchecksell.status}</td>
                                <td><button class="btn btn-primary btn-sm edit_btn" onclick="deleteunchecksell(${unchecksell.id})">取消</button></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
...
<script>
    ...
    function deleteunchecksell(id) {
        $.ajax({
            url:"${pageContext.request.contextPath}/deleteunchecksell",
            data:"id="+id,
            dataType: "text",
            type:"GET",
