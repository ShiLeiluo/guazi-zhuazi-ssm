            ...
            <div class="panel panel-default">
                ...
                <div class="table-responsive">
                    <table id="table-id" class="table table-bordered table-hover">
                        ...
                        <c:forEach items="${confirmsell}" var="confirmsell">
                            <tr>
                                <td>${confirmsell.oid}</td>
                                <td>${confirmsell.orderedid}</td>
                                <td><a href="/detail?id=${confirmsell.orderedid}">${confirmsell.name}</a></td>
                                <td>${confirmsell.nowprice}</td>
                                <td>${confirmsell.phone}</td>
                                <td>${confirmsell.cityname}</td>
                                <td>${confirmsell.status}</td>
                                <td><button class="btn btn-primary btn-sm edit_btn" onclick="cancelorder(${confirmsell.oid})">确认交易</button></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
...
<script>
    ...
    function cancelorder(oid) {
        $.ajax({
            url:"${pageContext.request.contextPath}/confirmstatus",
            data:"oid="+oid,
            dataType: "text",
            type:"GET",
