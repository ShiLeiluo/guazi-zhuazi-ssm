            ...
            <div class="panel panel-default">
                ...
                <div class="table-responsive">
                    <table id="table-id" class="table table-bordered table-hover">
                        ...
                        <c:forEach items="${undoneOrders}" var="undoneOrders">
                            <tr>
                                <td>${undoneOrders.oid}</td>
                                <td>${undoneOrders.orderedid}</td>
                                <td><a href="/detail?id=${undoneOrders.orderedid}">${undoneOrders.name}</a></td>
                                <td>${undoneOrders.nowprice}</td>
                                <td>${undoneOrders.phone}</td>
                                <td>${undoneOrders.cityname}</td>
                                <td>${undoneOrders.status}</td>
                                <td><button class="btn btn-primary btn-sm edit_btn" onclick="cancelorder(${undoneOrders.oid})">删除</button></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
